...
- Related to `job-profiles` capability: Authenticated user_id is required for profile creation and access
- Related to future `team-collaboration` capability: Auth forms foundation for multi-user access controls
